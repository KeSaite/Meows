const EN = Object.freeze({
  ...
  "meta_description": "Meows checks Linux servers from Android over SSH. Nothing is installed server-side; there is no telemetry or subscription.",
  "meta_title": "Meows — SSH server monitoring for Android",
...
const ZH_CN = Object.freeze({
  ...
  "meta_description": "Meows 通过 SSH 在 Android 手机上查看 Linux 服务器，服务器端不用安装东西，没有遥测和订阅。",
  "meta_title": "Meows — Android 上的 SSH 服务器监控",
...
const ZH_TW = Object.freeze({
  ...
  "meta_description": "Meows 透過 SSH 在 Android 手機查看 Linux 伺服器，伺服器端不用安裝東西，沒有遙測和訂閱。",
  "meta_title": "Meows — Android 上的 SSH 伺服器監控",
...
const JA = Object.freeze({
  ...
  "meta_description": "Meows は Android から SSH で Linux サーバーを確認するアプリです。サーバー側のインストール、テレメトリ、サブスクリプションはありません。",
  "meta_title": "Meows — Android の SSH サーバー監視",
...
const KO = Object.freeze({
  ...
  "meta_description": "Meows는 Android에서 SSH로 Linux 서버를 확인하는 앱입니다. 서버 측 설치, 텔레메트리, 구독이 없습니다.",
  "meta_title": "Meows — Android용 SSH 서버 모니터링",
