const EN = Object.freeze({
  ...
  "hero_body": "That became Meows. Add a server to see CPU, memory, disk, network, and other details over SSH on your phone.",
  ...
  "inside_lead": "Each part came from something I kept checking or looking up while managing my own servers.",
  "inside_title": "What I use on my own servers.",
  "language_auto": "Browser language",
  "language_label": "Language",
  "lens_body": "That is why I added Meows Lens. Tap an IP address, domain, URL, or permission string in the terminal or a Docker log, then choose the matching DNS, WHOIS, TLS, or permission action.",
  ...
  "more_title": "Docker, tunnels, and the small tools I kept looking up elsewhere.",
  "nav_docs": "Manual",
  "nav_get": "Google Play",
...
const ZH_CN = Object.freeze({
  ...
  "footer_privacy": "隐私政策",
  "hero_body": "后来就做了 Meows 这款应用。添加服务器后，就能在手机上看 CPU、内存、磁盘、网络，以及原来要进终端才看得到的信息。",
  "hero_caption": "总览顶部是世界地图，下面是服务器的实时状态。",
  "hero_kicker": "Android · 纯 SSH · 服务器端零安装",
  "hero_price": "一次买断",
  "hero_price_note": "没有订阅、广告和内购",
  "hero_title": "我只是想看一眼\n服务器，不想\n每次都开电脑。",
  "inside_lead": "这些功能都是我管自己服务器时反复要看、要查的东西，后来一点点加进了 App。",
  "inside_title": "这些是我平时真正在用的部分。",
  "language_auto": "跟随浏览器",
  "language_label": "语言",
  "lens_body": "所以做了 Meows Lens。点一下终端或 Docker 日志里的 IP、域名、URL 或权限字符串，再选择对应的 DNS、WHOIS、TLS 或权限换算。",
  "lens_label": "终端 + Lens",
  ...
  "more_label": "其他工具",
  "more_title": "Docker、隧道，还有那些我原来每次都要现查的小工具。",
  "nav_docs": "使用说明",
  "nav_get": "Google Play",
  "nav_inside": "App 里面",
  "nav_label": "主导航",
  ...
  "story_p2": "小鸡本来资源就不多，我也不想为了监控再改服务器环境。Meows 直接用现成的 SSH，在手机端读取 Linux 提供的系统信息。",
...
const ZH_TW = Object.freeze({
  ...
  "hero_body": "後來就做了 Meows 這款 App。新增伺服器後，就能在手機上查看 CPU、記憶體、磁碟、網路，以及原本要進終端機才看得到的資訊。",
  "hero_caption": "總覽頂部是世界地圖，下面是伺服器的即時狀態。",
  "hero_kicker": "Android · 純 SSH · 伺服器端零安裝",
  "hero_price": "一次買斷",
  "hero_price_note": "沒有訂閱、廣告和應用程式內購",
  "hero_title": "我只是想看一眼\n伺服器，不想\n每次都開電腦。",
  "inside_lead": "這些功能都是我管理自己伺服器時反覆要看、要查的東西，後來慢慢加進了 App。",
  "inside_title": "這些是我平常真的會用到的部分。",
  "language_auto": "跟隨瀏覽器",
  "language_label": "語言",
  "lens_body": "所以做了 Meows Lens。點一下終端機或 Docker 日誌中的 IP、網域、URL 或權限字串，再選擇對應的 DNS、WHOIS、TLS 或權限換算。",
  "lens_label": "終端機 + Lens",
  "lens_note": "它不會自行查詢、開啟網頁或執行命令，所有操作都要由你點選。",
  "lens_stack_aria": "Meows 工具頁和 Lens",
  "lens_title": "日誌裡看到網域後，還得切到工具頁查，來回很麻煩。",
  ...
  "more_label": "其他工具",
  "more_title": "Docker、隧道，還有那些我原本每次都得現查的小工具。",
  "nav_docs": "使用說明",
  "nav_get": "Google Play",
  "nav_inside": "App 裡面",
  "nav_label": "主導覽",
  ...
  "privacy_q3": "連線路徑",
  "privacy_q4": "可選備份",
  "privacy_title": "App 裡存有 SSH 密碼和私鑰，這部分不能馬虎。",
  "q1": "伺服器上需要安裝東西嗎？",
...
const JA = Object.freeze({
  ...
  "hero_body": "それで Meows を作りました。サーバーを追加すると、CPU、メモリ、ディスク、ネットワークなど、以前はターミナルで確認していた情報をスマートフォンで見られます。",
  ...
  "inside_lead": "自分のサーバーを管理しながら何度も確認したり調べたりしたものを、少しずつアプリへ追加しました。",
  "inside_title": "自分のサーバーで実際に使っている部分です。",
  "language_auto": "ブラウザーの言語",
  "language_label": "言語",
  "lens_body": "そこで Meows Lens を追加しました。ターミナルや Docker ログにある IP、ドメイン、URL、権限文字列をタップし、対応する DNS、WHOIS、TLS、権限計算を選べます。",
  ...
  "more_label": "その他のツール",
  "more_title": "Docker、トンネル、以前は使うたびに調べていた小さなツール。",
  "nav_docs": "マニュアル",
  "nav_get": "Google Play",
  "nav_inside": "アプリの中",
...
const KO = Object.freeze({
  ...
  "footer_privacy": "개인정보",
  "hero_body": "그래서 Meows를 만들었습니다. 서버를 추가하면 CPU, 메모리, 디스크, 네트워크 등 이전에는 터미널에서 확인하던 정보를 휴대폰에서 볼 수 있습니다.",
  ...
  "inside_lead": "제 서버를 관리하면서 자주 확인하거나 찾아보던 것들을 조금씩 앱에 추가했습니다.",
  "inside_title": "제 서버에서 실제로 쓰는 부분입니다.",
  "language_auto": "브라우저 언어 따르기",
  "language_label": "언어",
  "lens_body": "그래서 Meows Lens를 추가했습니다. 터미널이나 Docker 로그에서 IP, 도메인, URL, 권한 문자열을 누른 뒤 알맞은 DNS, WHOIS, TLS, 권한 계산 작업을 선택할 수 있습니다.",
  "lens_label": "터미널 + Lens",
  ...
  "more_label": "기타 도구",
  "more_title": "Docker, 터널, 예전에는 쓸 때마다 찾아보던 작은 도구들.",
  "nav_docs": "사용 설명서",
  "nav_get": "Google Play",
  "nav_inside": "앱 기능",
  "nav_label": "주요 탐색",
